---
title: "Linear Regression Models, Chapter 1, Topic 2: Simple Linear Regression Model (SLRM) and its assumptions
"
editor_options:
...
```{r}
# Fit a simple linear regression model for the true population data
